...
class Accounting {
    ...
    public static void main(String[] args) {
        ...
        BillDetail bill1_detail1 = new BillDetail(1, "Bolígrafos", 2.99f);
        BillDetail bill1_detail2 = new BillDetail(2, "Cuadernos", 35.99f);
        BillDetail bill1_detail3 = new BillDetail(3, "Lapiceros", 1.99f);
        bill1.addDetail(bill1_detail1, bill1_detail2, bill1_detail3);
        
        Bill bill2 = new Bill("Compra de material de oficina");
        BillDetail bill2_detail1 = new BillDetail(1, "Grapas", 3.49f);
        BillDetail bill2_detail2 = new BillDetail(2, "Clips", 2.29f);
        BillDetail bill2_detail3 = new BillDetail(3, "Fundas A4", 1.19f);
