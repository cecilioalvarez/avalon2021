package _009_Metodo_Clase_File;
...
public class Objeto04_Propiedad_listFiles_and_getName {
	...
	public static void main(String[] args) throws IOException {
		...
		if (fichero.isDirectory()) {
			//aca estamos trabajando con string o cadenas para obtener una lista de los ficheros
			//aca trato con una lista de ficheros
			//con listFiles listo todos los ficheros dentro de una lista
			// y ya puedo revisar las propiedades de las listas (ej:getName)
